...
public class UserController {
	...
	public void loginByQq(String qq, String gender, String address, MultipartFile imgFile, HttpServletResponse response, HttpServletRequest request) {
		response.setCharacterEncoding("utf-8");
		String newName = null;
		if(imgFile != null) {
			//获取后缀名
		...
		String res = userServiceImpl.loginByQq(qq, gender, address, "/heads", newName);
	...
	public void addUserInfo(HttpServletRequest request, HttpServletResponse response, Integer id, String detailAddress, String phone, String qq, String username, String password, MultipartFile imgFile, String address, String gender) {
		...
		//更新数据
		String res = userServiceImpl.upUserInfo(id, phone, qq, username, password, "/heads", newName, address, gender, detailAddress);
		System.out.println(res);
		try {
			response.getWriter().print(res);
		} catch (IOException e) {
